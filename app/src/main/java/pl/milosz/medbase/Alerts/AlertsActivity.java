...
public class AlertsActivity extends AppCompatActivity implements android.app.TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener, NotificationTextFragment.NotificationTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(view -> sendOnDate(view));
    }
    ...
    public void getText(String notificationText) {
        ...
        switch (index) {
            case 0:
                ...
                break;
            case 1:
                addSwitch(sw1, alarmManager1);
                break;
            case 2:
                addSwitch(sw2, alarmManager2);
                break;
            case 3:
                addSwitch(sw3, alarmManager3);
                break;
            case 4:
                addSwitch(sw4, alarmManager4);
                break;
            case 5:
                addSwitch(sw5, alarmManager5);
                break;
            default:
                break;
        }
